...
const taskSchema = z.object({
  ...
  activite: z.string().min(1, "Activite requise"),
  tache: z.string().min(1, "Tache requise"),
              ...
              <Tabs defaultValue="general" className="w-full">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input {...field} placeholder="Nom de l'activite ou phase" data-testid="input-task-activite" /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input {...field} placeholder="Nom de la tache" data-testid="input-task-tache" /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Textarea {...field} rows={3} placeholder="Description detaillee" data-testid="input-task-description" /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl><Input {...field} placeholder="Source de la tache" /></FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input {...field} placeholder="Nature de la tache" /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                ...
                <TabsContent value="planning" className="space-y-4 pb-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Etat d'avancement</FormLabel>
                        <Select onValueChange={field.onChange} value={field.value}>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Textarea {...field} rows={2} placeholder="Resultat attendu" /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>IOV</FormLabel>
                        <FormControl><Input {...field} placeholder="Indicateur de verification" /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                ...
                <TabsContent value="suivi" className="space-y-4 pb-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Extrants obtenus a date</FormLabel>
                        <FormControl><Textarea {...field} rows={3} placeholder="Resultats obtenus jusqu'a present" /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  <FormField
                    control={form.control}
                    name="livrablesFournis"
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Livrables fournis</FormLabel>
                        <FormControl><Textarea {...field} rows={2} placeholder="Livrables deja fournis" /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
